...
class Plugin(plugin.Plugin):
    ...
    def current(self, message, args):
        u""" Fetches the current weather in <span class="irc"><span class="repl">location</span></span>.
    ...
    def forecast(self, message, args):
        u""" Fetches the weather forecast for <span class="irc"><span class="repl">location</span></span>.
